...
extension CategoryListingVC {
    ...
    func setCustomNav() {
        ...
        btnSearch.setImage(#imageLiteral(resourceName: "ic_search"), for: UIControl.State.normal)
        ...
        //self.navigationItem.setRightBarButtonItems([barBtnNotify, barBtnMsg, barBtnSearch], animated: true)
