...
class BaseVC: UIViewController {
    ...
    func setNavigationBar(_ parent: UIViewController)
    {
        ...
        if let globalSelf = self.globalSelf {
            ...
            globalSelf.navigationController?.navigationBar.barTintColor = AppTheme.navBarthemeColor()
            globalSelf.navigationController?.navigationBar.tintColor = AppTheme.navBarthemeColor()
