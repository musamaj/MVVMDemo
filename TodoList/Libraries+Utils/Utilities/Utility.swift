...
class Utility:NSObject {
    ...
    static func showDeletion() {
        let alert = UIAlertController(title: "", message: "Are you sure you want to delete this?", preferredStyle: .actionSheet)
    ...
    static func showWarning(_ msg: String = "Your access has been revoked.", _ cancelBtn: Bool = false) {
    ...
    class func showSnackBar(msg: String, icon: UIImage?) {
