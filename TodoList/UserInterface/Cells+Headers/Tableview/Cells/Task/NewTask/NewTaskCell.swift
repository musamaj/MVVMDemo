...
class NewTaskCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        contentView.frame = contentView.frame.inset(by: UIEdgeInsets(top: 15, left: App.Constants.fieldPadding, bottom: App.Constants.fieldPadding, right: App.Constants.fieldPadding))
